...
int manage::info_read ( car *info )
{
	...
	int j;																							  //停车位车辆数
	ifstream fin ( "D:\\VSCode\\work\\Windows\\Freshman_course_design\\Second_Semester\\car_info.txt" ); //此处为绝对路径，克隆到本地后需注意
	if ( !fin )
	{
		cout << "文件打开失败" << endl;
...
#endif
//File's name:manage.h
//==================================================//
//            Author:          Iridescent-9         //
//            Email:           syhan1228@vip.qq.com //
//            Creat Time:      2020-06-16 17:25:56  //
//==================================================//